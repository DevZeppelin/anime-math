...
export const OUTFITS: ItemDef[] = [
  { id: "out_school", type: "outfit", name: "Uniforme Escolar", emoji: "🎒", rarity: "comun", price: 0, desc: "El clásico para empezar la aventura.", variant: "suit", c1: "#3d5a99", c2: "#2b3f6b", c3: "#ffd24d" },
  ...
  { id: "out_ninja", type: "outfit", name: "Traje Ninja", emoji: "🥷", rarity: "raro", price: 420, desc: "Silencioso como una sombra.", variant: "suit", c1: "#33334d", c2: "#1f1f33", c3: "#8b5cff" },
  { id: "out_mage", type: "outfit", name: "Túnica de Mago", emoji: "🔮", rarity: "raro", price: 420, desc: "Tejida con hilos de estrellas.", variant: "robe", c1: "#5d3fd3", c2: "#3d2a8f", c3: "#ffd24d" },
...
export const WEAPONS: ItemDef[] = [
  { id: "wp_stick", type: "weapon", name: "Vara de Madera", emoji: "🪵", rarity: "comun", price: 80, desc: "Todo héroe empieza por algo.", variant: "stick", c1: "#a07040", c2: "#7a5028" },
  ...
  { id: "wp_slingshot", type: "weapon", name: "Resortera", emoji: "🪀", rarity: "comun", price: 120, desc: "Puntería y precisión.", variant: "slingshot", c1: "#a07040", c2: "#ff5a5a" },
  ...
  { id: "wp_hammer", type: "weapon", name: "Martillo de Forja", emoji: "🔨", rarity: "raro", price: 340, desc: "Construye y protege.", variant: "hammer", c1: "#7c88a0", c2: "#a07040" },
  ...
  { id: "wp_katana", type: "weapon", name: "Katana de Luna", emoji: "🌙", rarity: "epico", price: 750, desc: "Afilada como un rayo de luna.", variant: "katana", c1: "#d6dcff", c2: "#8f7bff" },
  ...
  { id: "wp_excalibur", type: "weapon", name: "Excálibur Dorada", emoji: "🗡️", rarity: "legendario", price: 0, gems: 20, desc: "La espada de los grandes sabios.", variant: "sword", c1: "#ffd24d", c2: "#ff9d2e" },
];
...
export const ACCESSORIES: ItemDef[] = [
  ...
  { id: "ac_catears", type: "accessory", name: "Orejas de Gato", emoji: "🐱", rarity: "raro", price: 280, desc: "¡Nyan!", variant: "catears", c1: "#ff8fc4", c2: "#ffc7e0" },
