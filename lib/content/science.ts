...
function build(mcs: MC[], tfs: TF[] = [], take = 10): Question[] {
  const qs: Question[] = [
...
const ANIMALS_MC: MC[] = [
  ...
  ["¿Qué animal es un reptil?", "La tortuga", ["La salamandra", "El sapo", "El ratón"], "🐢"],
  ["¿Qué animal es un anfibio?", "La rana", ["La lagartija", "La serpiente", "el pez payaso"], "🐸", "Los anfibios viven en el agua y en la tierra."],
  ["¿Qué animal es un insecto?", "La hormiga", ["La araña", "El caracol", "La lombriz"], "🐜", "Los insectos tienen 6 patas; las arañas tienen 8."],
  ["¿Cuál de estos animales es herbívoro?", "La vaca", ["El león", "El lobo", "El águila"], "🐮"],
  ["¿Cuál de estos animales es carnívoro?", "El tigre", ["El conejo", "La jirafa", "El caballo"], "🐯"],
...
const BODY_MC: MC[] = [
  ["¿Qué órgano bombea la sangre?", "El corazón", ["El cerebro", "El estómago", "Los pulmones"], "❤️"],
  ["¿Con qué órgano pensamos?", "El cerebro", ["El corazón", "El hígado", "Los riñones"], "🧠"],
  ["¿Qué órganos usamos para respirar?", "Los pulmones", ["Los riñones", "Los músculos", "Los huesos"], "🫁"],
  ...
  ["¿Qué sentido usamos con la piel?", "El tacto", ["El gusto", "La vista", "El oído"], "✋"],
...
const MATTER_MC: MC[] = [
  ...
  ["¿Cuál es un líquido?", "La leche", ["La piedra", "El aire", "La madera"], "🥛"],
...
const EARTH_MC: MC[] = [
  ["¿Qué cubre la mayor parte de la Tierra?", "Agua", ["Tierra", "Hielo", "Arena"], "🌊", "Casi 3 de cada 4 partes del planeta son océanos."],
  ...
  ["¿Qué instrumento mide la temperatura?", "El termómetro", ["La brújula", "La regla", "El reloj"], "🌡️"],
...
const ECO_MC: MC[] = [
  ["¿Dónde debe ir una botella de plástico usada?", "Al contenedor de reciclaje", ["Al suelo", "Al río", "A la fogata"], "♻️"],
  ["¿Cuál es una energía limpia?", "La energía solar", ["El carbón", "El petróleo", "La gasolina"], "☀️"],
  ...
  ["¿Qué material tarda MÁS en desaparecer en la naturaleza?", "El plástico", ["Una cáscara de banana", "El papel", "Una hoja seca"], "🥤"],
...
const INVENT_MC: MC[] = [
  ...
  ["Los hermanos Wright inventaron…", "El avión", ["El barco", "El tren", "El submarino"], "✈️"],
...
export const SCIENCE_LEVELS: LevelDef[] = [
  { name: "Reino Animal", emoji: "🦁", desc: "Mamíferos, aves, reptiles y más", tier: 1, gen: () => build(ANIMALS_MC) },
  { name: "Mundo Verde", emoji: "🌱", desc: "Las plantas y sus secretos", tier: 1, gen: () => build(PLANTS_MC) },
  { name: "Mi Cuerpo", emoji: "🫀", desc: "Órganos, sentidos y salud", tier: 2, gen: () => build(BODY_MC) },
  { name: "Laboratorio de Materia", emoji: "🧪", desc: "Sólidos, líquidos, gases y el ciclo del agua", tier: 2, gen: () => build(MATTER_MC) },
  { name: "Viaje Espacial", emoji: "🚀", desc: "El Sol, la Luna y los planetas", tier: 2, gen: () => build(SPACE_MC) },
  { name: "Planeta Tierra", emoji: "🌍", desc: "Océanos, volcanes, clima y estaciones", tier: 2, gen: () => build(EARTH_MC) },
  { name: "Guardianes del Planeta", emoji: "♻️", desc: "Ecología, reciclaje y energía limpia", tier: 3, gen: () => build(ECO_MC) },
  { name: "Grandes Mentes", emoji: "🔬", desc: "Inventos, científicos y verdadero o falso", tier: 3, gen: () => build(INVENT_MC, MIX_TF) },
];
